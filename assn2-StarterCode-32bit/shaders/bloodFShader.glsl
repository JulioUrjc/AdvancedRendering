...
uniform sampler2D textureBlood;
...
void main(){
	...
	//Texture
	outColor =(texture2D(textureBlood, vTextCoord)*showTexture*0.2f + vec4(amb+diffuse+specular,1)*(1-showTexture)*(1-mutation)*0.7f + vec4(ret,1)*mutation*1.0f);
}
